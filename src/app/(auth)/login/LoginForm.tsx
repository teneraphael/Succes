      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 w-full">
            ...
            <FormItem>
              ...
              <div className="flex justify-end px-1 mt-1">
                <Link
                  ...
                  className="text-[10px] font-black uppercase tracking-widest text-[#4a90e2]/60 hover:text-[#4a90e2] transition-colors italic"
                >
                  Mot de passe oublié ?
                </Link>
              </div>
        ...
        <div className="relative py-1">
          ...
          <div className="relative flex justify-center text-[10px] font-black uppercase tracking-[0.2em]">
            <span className="bg-white dark:bg-zinc-900 px-4 text-muted-foreground/50">
              Ou
            </span>
          </div>
        </div>
        ...
        >
          ...
          <span className="text-sm font-black uppercase tracking-tight text-foreground/70 group-hover:text-foreground transition-colors">
