        ...
        <div className="w-full max-w-[540px] space-y-6 animate-in fade-in slide-in-from-bottom-8 duration-700">
          ...
          <div className="flex flex-col items-center text-center space-y-3">
            <div className="flex items-end gap-2.5 transform hover:scale-105 transition-transform duration-300">
              <span className="text-4xl font-black tracking-tighter bg-gradient-to-r from-[#4a90e2] to-[#6ab344] bg-clip-text text-transparent">
                DealCity
              </span>
              <span className="text-xs font-black bg-zinc-900 dark:bg-zinc-100 dark:text-zinc-900 text-white px-2 py-0.5 rounded-lg shadow-md uppercase tracking-wider">
                PRO
              </span>
            </div>
            ...
            <div className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-blue-50 dark:bg-blue-500/10 border border-blue-100/50 dark:border-blue-500/20 shadow-sm">
              ...
              <span className="text-[10px] font-extrabold uppercase tracking-[0.15em] text-[#4a90e2]">
                {t.become_seller}
              </span>
            </div>
          ...
          <div className="relative">
            <div className="absolute -inset-0.5 rounded-[32px] bg-gradient-to-r from-[#4a90e2] to-[#6ab344] opacity-20 blur-lg transition duration-1000" />
              ...
              <form onSubmit={onSubmit} className="space-y-6 pt-2">
                ...
                <div className="space-y-3.5">
                  <p className="text-[10px] font-black uppercase text-amber-600 dark:text-amber-500 tracking-wider flex items-center gap-1">
                    <Phone className="size-3" /> {t.whatsapp_number}
                  </p>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                    <div className="relative">
                      ...
                      <Input name="facebookUrl" placeholder="Facebook (Optionnel)" className="h-13 pl-12 rounded-xl bg-slate-50/50 dark:bg-zinc-800/40 border-slate-200 dark:border-zinc-800 focus-visible:ring-blue-500" />
                    </div>
                    <div className="relative">
                      <Instagram className="absolute left-4 top-1/2 -translate-y-1/2 size-5 text-pink-500" />
                      <Input name="instagramUrl" placeholder="Instagram (Optionnel)" className="h-13 pl-12 rounded-xl bg-slate-50/50 dark:bg-zinc-800/40 border-slate-200 dark:border-zinc-800 focus-visible:ring-pink-500" />
                    </div>
                  </div>
