...
// ✅ Stats modernisées : style épuré en ligne (Style Twitter/X) avec Clics WhatsApp
export function ProfileStats({
  postsCount,
  followersNode,
  salesCount, // Représente maintenant le compteur de clics WhatsApp
}: {
  postsCount: number;
  ...
  return (
    <div className="flex flex-wrap items-center gap-x-5 gap-y-1.5 pt-1 text-sm select-none">
      ...
      {/* ✅ Clics WhatsApp : Remplacement de l'icône de vente par l'icône WhatsApp SVG native */}
      <div className="flex items-center gap-1.5 transition-opacity hover:opacity-80 cursor-pointer">
