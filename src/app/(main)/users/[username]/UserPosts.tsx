    ...
    >
      <div className="relative w-full aspect-square overflow-hidden bg-zinc-100 dark:bg-zinc-900">
        ...
        <div className="absolute bottom-2 left-2 flex items-center gap-1.5">
          ...
          {/* NOMBRE DE VUES */}
          <div className="bg-black/60 text-white text-[9px] font-bold px-1.5 py-0.5 rounded-full backdrop-blur-sm flex items-center gap-1">
